...
RUN comfy node install --exit-on-fail was-ns@3.0.1 efficiency-nodes-comfyui@1.0.9 comfyui-advanced-controlnet@1.6.0 comfyui_controlnet_aux@1.1.5 comfyui-impact-subpack@1.3.5 --mode remote
